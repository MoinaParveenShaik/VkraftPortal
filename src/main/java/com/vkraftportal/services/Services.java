...
//	------------------------------------------Timesheet Services-----------------------------------
	...
	public boolean deleteByEmployeeNumberAndDate(String empNumber, String month, String year) {
		...
		EmployeeTimesheet employeeTimesheet = employeeTimesheetRepo.findByEmployeeNumberAndYear(empNumber, year);
	...
	public List<Timesheet> getEmployeesByMonthAndYearAndNewStatus(String month, String year, String newStatus) {
		if (month != null && year != null && newStatus.equals("Approved") ) {
			List<Timesheet> findByMonthandYear = timesheetRepo.findByMonthAndYearAndNewStatus(month, year, newStatus);
				return findByMonthandYear;
		}
		return null;
	}

	public boolean deleteByEmployeeNumberAndName(String empNumber, String month, String year) {
		Timesheet findByEmpNumber = timesheetRepo.findByEmployeeNumberAndMonthAndYear(empNumber, month, year);

		if (findByEmpNumber != null) {
			timesheetRepo.deleteByEmployeeNumberAndMonthAndYear(empNumber, month, year);
			System.out.println("inside findByEmpNumber");
			return true;
		} else {
			return false;
		}
	...
	public List<Timesheet> findByProjectNameMonthYear(String projectName, String month, String year) {
	...
	public List<Timesheet> getEmployeeByStatus(String string) {
		if (string.equals("Pending")) {
	...
	public EmployeeTimesheet findByEmployeNumber(String employeeNumber, String month) {
	...
	public RegisterEmployee findByRole(String role) {
		RegisterEmployee emp = employeeRepo.findByRole("Employee");
		return emp;
	}

	public EmployeeTimesheet findByEmployeNumber(String employeeNumber, String month, String year) {
		EmployeeTimesheet num = employeeTimesheetRepo.findByEmployeeNumber(employeeNumber);
		System.out.println("month : " + month + "num " + num);
		if (num != null) {
			if (month.equals("January")) {
				num.setJanuary("Submitted & Approved");
			}
			if (month.equals("February")) {
				System.out.println("inside if (month.equals(\"February\")) ");
				num.setFebruary("Submitted & Approved");
			}
			if (month.equals("March")) {
				num.setMarch("Submitted & Approved");
			}
			if (month.equals("April")) {
				num.setApril("Submitted & Approved");
			}
			if (month.equals("May")) {
				num.setMay("submitted & approved");
			}
			if (month.equals("June")) {
				num.setJune("Submitted & Approved");
			}
			if (month.equals("July")) {
				num.setJuly("Submitted & Approved");
			}
			if (month.equals("August")) {
				num.setAugust("Submitted & Approved");
			}
			if (month.equals("September")) {
				num.setSeptember("Submitted & Approved");
			}
			if (month.equals("October")) {
				num.setOctober("Submitted & Approved");
			}
			if (month.equals("November")) {
				num.setNovember("Submitted & Approved");
			}
			if (month.equals("December")) {
				num.setDecember("Submitted & Approved");
			}
	...
	public String approvedSubject(Timesheet body) {
		String subject = null;
		String month = body.getMonth();
		String year = body.getYear();
		String newStatus = body.getNewStatus();
		if ("Approved".equals(newStatus)) {
			subject = "Timesheet Approval for " + month + " " + year;
		}
		System.out.println(subject);
		return subject;
	}

//	Email body for approved
...
//	---------------------Referred Candidate Methods---------------------------------------
	...
	public RegisterEmployee findEmployeeByEmployeeNumber(String employeeNumber) {
